...
def intersection(x, n, P, Pr):
    """
        Function calculates the intersection of obtaining this data
    ...
    pep8cut = (P ** x) * ((1 - P) ** (n - x)) * Pr
    intersection = (np.math.factorial(n) / (np.math.factorial(x) *
                    np.math.factorial(n - x))) * pep8cut
